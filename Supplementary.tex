...
\caption{Distribution of outcome and time-varying covariates. Fasting glucose variables are right-skewed (skewness $1.8$--$2.1$), motivating log transformation. Waist circumference is approximately normal.}
\end{figure}

% ---- S2: Per-metal dose-response (full) ----
\begin{figure}[h]
\centering
